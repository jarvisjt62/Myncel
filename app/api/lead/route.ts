...
export async function POST(req: Request) {
  try {
    ...
    const notificationRecipient = 'info@myncel.com'
    ...
    await savePublicFormSubmission({
      ...
      subject: `Downloaded ${source || 'lead magnet'}`,
      source: source || 'Lead capture',
    ...
    await sendEmail({
      ...
      html: `
        ...
        <p>You can download your checklist here: <a href="https://www.myncel.com/guides/pm-checklist?download=true">Download Checklist</a></p>
        ...
        <p>If you're looking to streamline your maintenance operations, consider trying <a href="https://www.myncel.com/signup">Myncel free for 30 days</a>.</p>
