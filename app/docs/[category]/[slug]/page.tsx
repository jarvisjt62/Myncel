...
1. Go to [myncel.com/signup](https://www.myncel.com/signup)
...
- **Starter Plan**: Up to 25 machines and up to 10 users
- **Growth Plan**: Up to 100 machines and up to 25 users
- **Professional Plan**: Up to 500 machines and up to 100 users
...
\`\`\`bash
curl -X GET "https://www.myncel.com/api/equipment" \\
