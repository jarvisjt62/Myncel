...
export const metadata = {
  title: 'Preventive Maintenance Software — Reduce Breakdowns & Downtime',
  description: 'Myncel preventive maintenance software helps manufacturers schedule recurring PM tasks, track compliance, automate due dates, and reduce unplanned downtime before failures happen.',
  alternates: { canonical: 'https://www.myncel.com/products/preventive' },
};
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[#425466] leading-relaxed mb-8">
              Shift from reactive firefighting to planned maintenance with preventive maintenance software built for manufacturing teams. Schedule recurring PM tasks, track compliance, and reduce unplanned downtime by up to 35%.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-[#0a2540]">Everything you need for effective preventive maintenance software</h2>
          </div>
      ...
      <section className="py-20 bg-teal-600">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-teal-200 mb-8 text-lg">Start your free 30-day trial. No credit card required.</p>
