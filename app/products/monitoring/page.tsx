...
export const metadata = {
  title: 'Equipment Maintenance Software — Machine Monitoring Dashboard',
  description: 'Myncel equipment maintenance software gives manufacturers a real-time machine health dashboard, service history, asset records, maintenance status, and predictive maintenance visibility.',
  alternates: { canonical: 'https://www.myncel.com/products/monitoring' },
};
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[#425466] leading-relaxed mb-8">
              Get real-time equipment maintenance software visibility into every machine in your facility. Track status, service history, upcoming tasks, and predictive maintenance signals from one dashboard—without walking the floor to check on equipment.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-[#0a2540]">Everything you need to manage equipment maintenance</h2>
          </div>
      ...
      <section className="py-20 bg-violet-600">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-violet-200 mb-8 text-lg">Start your free 30-day trial. No credit card required.</p>
