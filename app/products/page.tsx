...
export const metadata = {
  title: 'CMMS Software Products — Maintenance, Work Orders & Monitoring',
  description: 'Explore Myncel\'s CMMS software suite for manufacturers: preventive maintenance software, work order management software, equipment monitoring, predictive maintenance insights, parts inventory, analytics, and mobile access.',
  alternates: { canonical: 'https://www.myncel.com/products' },
  openGraph: {
    title: 'Myncel Products — CMMS and Predictive Maintenance Software for Manufacturers',
    description: 'Everything your maintenance team needs in one CMMS: monitoring, preventive scheduling, work orders, alerts, analytics and more.',
    url: 'https://www.myncel.com/products',
  },
}
  ...
  const products = [
    {
      ...
      tagline: 'Equipment maintenance software visibility into every machine in your facility.',
    ...
    },
    {
      ...
      tagline: 'Preventive maintenance software that keeps every task on schedule.',
    ...
    },
    {
      ...
      tagline: 'Work order management software from task creation to completion.',
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl font-bold text-[#0a2540] leading-tight mb-6">
              CMMS software with everything your maintenance team needs.{' '}
              <span className="gradient-text">Nothing they don't.</span>
            </h1>
            <p className="text-xl text-[#425466] leading-relaxed mb-8">
              Myncel is a complete CMMS software platform built specifically for small manufacturers, combining equipment maintenance software, preventive maintenance software, work order management software, alerts, inventory, and predictive maintenance analytics in one unified system.
            </p>
      ...
      <section className="py-16 bg-[#f6f9fc] border-t border-[#e6ebf1]">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#0a2540] mb-3">Coming from another CMMS?</h2>
            <p className="text-[#425466]">See how Myncel compares feature-by-feature.</p>
          </div>
      ...
      <section className="py-20 bg-[#635bff]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-purple-200 mb-8 text-lg">Start your free 30-day trial. No credit card. Setup in 15 minutes.</p>
