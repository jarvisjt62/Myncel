...
export const metadata = {
  title: 'Work Order Management Software — Digital Maintenance Work Orders',
  description: 'Myncel work order management software replaces paper maintenance forms with digital work orders for assignments, photos, labor, parts, priorities, and real-time completion tracking.',
  alternates: { canonical: 'https://www.myncel.com/products/work-orders' },
};
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[#425466] leading-relaxed mb-8">
              Replace paper maintenance forms with work order management software your team can access from any device. Assign tasks, attach photos, log parts used, prioritize work, and track completion in real time.
            </p>
      ...
      <section className="py-20 bg-[#f6f9fc]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-[#0a2540]">Everything you need in work order management software</h2>
          </div>
      ...
      <section className="py-20 bg-emerald-600">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-emerald-200 mb-8 text-lg">Start your free 30-day trial. No credit card required.</p>
