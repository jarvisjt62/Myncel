...
export const metadata = {
  ...
  description: 'Manage your maintenance team with role-based access, task assignment, and performance tracking across the user limits included in each plan.',
  alternates: { canonical: 'https://www.myncel.com/products/team' },
};

export default function Team() {
  const features = [
    { icon: '👤', title: 'Role-Based Users', desc: 'Starter includes up to 10 users, Growth up to 25 users, Professional up to 100 users, and Enterprise can be customized for larger teams.' },
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[#425466] leading-relaxed mb-8">
              Manage your maintenance team with role-based access, task assignment, and performance tracking across Starter, Growth, Professional, and Enterprise user limits.
            </p>
