...
export const metadata = {
  title: 'Preventive Maintenance Scheduling Software — Automated PM Tasks',
  description: 'Automate preventive maintenance scheduling with recurring PM tasks by calendar days, operating hours, production cycles, or meter readings so maintenance is completed on time.',
  alternates: { canonical: 'https://www.myncel.com/products/scheduling' },
};
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[#425466] leading-relaxed mb-8">
              Set up recurring preventive maintenance schedules by calendar days, operating hours, production cycles, or meter readings. Myncel automatically calculates every due date and surfaces what needs attention before it becomes a breakdown.
            </p>
      ...
      <section className="py-20 bg-[#f6f9fc]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-[#0a2540]">Powerful preventive maintenance scheduling made simple</h2>
          </div>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-blue-200 mb-8 text-lg">Start your free 30-day trial. No credit card required.</p>
