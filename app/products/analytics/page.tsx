...
export const metadata = {
  title: 'Predictive Maintenance Software Analytics & Reporting',
  description: 'Use predictive maintenance software analytics to understand maintenance costs, identify problem-prone equipment, track uptime, measure PM compliance, and reduce downtime.',
  alternates: { canonical: 'https://www.myncel.com/products/analytics' },
};
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <div className="max-w-3xl">
            <h1 className="text-4xl lg:text-5xl font-bold text-[#0a2540] leading-tight mb-6">
              Predictive Maintenance Software Analytics
            ...
            <p className="text-xl text-[#425466] leading-relaxed mb-8">
              Understand your true maintenance costs, identify problem-prone equipment, monitor downtime trends, and track your team\'s performance over time with predictive maintenance software analytics. Monthly reports are delivered automatically.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-[#0a2540]">Predictive maintenance KPIs built in</h2>
      ...
      <section className="py-20 bg-indigo-600">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-indigo-200 mb-8 text-lg">Start your free 30-day trial. No credit card required.</p>
