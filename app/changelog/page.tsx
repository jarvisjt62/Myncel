  ...
  const releases = [
    ...
    },
    {
      ...
      changes: [
        ...
        { type: 'new', text: 'New pricing plans — Starter ($49), Growth ($99), Professional ($249)' },
