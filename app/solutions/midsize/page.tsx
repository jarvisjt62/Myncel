...
export const metadata = {
  ...
  description: 'Professional maintenance management with custom reports, advanced integrations, and priority support for larger operations.',
  alternates: { canonical: 'https://www.myncel.com/solutions/midsize' },
};
...
export default function MidsizePlants() {
  const features = [
    ...
    { icon: '☎️', title: 'Priority Phone Support', desc: 'Get faster help from the support team when your larger maintenance operation needs assistance.' },
    { icon: '🔐', title: 'SSO / SAML', desc: 'Use single sign-on options designed for larger teams that need stronger access control.' },
    { icon: '📈', title: 'Up to 500 Machines', desc: 'Track larger equipment fleets with up to 500 machines, 100 users, and 10,000 work orders per month.' },
  ];
  ...
  const pricing = {
    ...
    features: ['Up to 500 machines', 'Up to 100 users', '10,000 work orders/month', 'Full analytics + custom reports', 'SSO / SAML', 'Priority phone support'],
  };

  const stats = [
    { value: '500', label: 'Machines included' },
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[#425466] leading-relaxed mb-8">
              Advanced reporting, API access, SSO, and priority phone support for larger maintenance teams that need more capacity without a custom enterprise contract.
            </p>
      ...
      <section className="py-20 bg-purple-600">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-purple-200 mb-8 text-lg">Start your free 30-day trial. No credit card required.</p>
