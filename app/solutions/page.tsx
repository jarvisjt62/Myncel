...
export const metadata = {
  ...
  description: 'Myncel CMMS software solutions help manufacturers and facility teams manage preventive maintenance, work orders, equipment maintenance, and predictive maintenance by industry and shop size.',
  alternates: { canonical: 'https://www.myncel.com/solutions' },
  openGraph: {
    title: 'Myncel Solutions — CMMS Software for Every Manufacturing Industry',
    description: 'Industry-specific CMMS software for small and mid-size manufacturers, including preventive maintenance, equipment maintenance, work orders, and analytics.',
    url: 'https://www.myncel.com/solutions',
  },
}
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-bold text-[#0a2540]">CMMS software solutions for every shop floor</h2>
      ...
      <section className="py-20 bg-[#f6f9fc]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-bold text-[#0a2540]">Find the right equipment maintenance software fit for your operation</h2>
          </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  ...
                  { feature: 'Cost per month', sentinel: '$49–$249', sheets: 'Free (but costly)', enterprise: '$2,000–$10,000+' },
      ...
      <section className="py-20 bg-[#0a2540]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-[#8898aa] mb-8 text-lg">30-day free trial. No credit card. Cancel anytime.</p>
