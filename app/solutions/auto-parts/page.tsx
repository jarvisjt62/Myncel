...
export const metadata = {
  ...
  alternates: { canonical: 'https://www.myncel.com/solutions/auto-parts' },
};
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-red-600">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-red-200 mb-8 text-lg">Start your free 30-day trial. No credit card required.</p>
