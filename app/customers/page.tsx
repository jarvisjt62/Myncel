...
export const metadata = {
  ...
  alternates: { canonical: 'https://www.myncel.com/customers' },
  openGraph: {
    title: 'Myncel Customer Stories',
    description: 'Real stories from real manufacturers.',
    url: 'https://www.myncel.com/customers',
  },
};
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-[#635bff]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-purple-200 mb-8 text-lg">Start your free 30-day trial and see results in the first week.</p>
