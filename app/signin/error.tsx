  ...
  return (
    <div className="min-h-screen bg-[#f6f9fc] flex items-center justify-center px-6">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-[#0a2540] mb-3">Sign In Error</h1>
        <p className="text-[#425466] mb-6">
          We encountered an error loading the sign in page. Please try again or contact support if the problem persists.
        </p>
