...
// Map admin nav items to their API endpoints for hover-based prefetching
const ADMIN_PREFETCH_MAP: Record<string, string> = {
  '/admin': '/api/admin/stats',
  '/admin/users': '/api/admin/users',
  '/admin/organizations': '/api/admin/organizations',
  '/admin/machines': '/api/admin/machines',
  '/admin/work-orders': '/api/admin/work-orders',
  '/admin/alerts': '/api/admin/alerts',
  '/admin/reports': '/api/admin/reports',
  '/admin/form-submissions': '/api/admin/form-submissions',
  '/admin/parts': '/api/admin/parts',
  '/admin/settings': '/api/admin/settings',
  '/admin/settings/platform': '/api/admin/settings',
  '/admin/api-keys': '/api/admin/api-keys',
  '/admin/billing': '/api/admin/billing',
};

interface NavItem { href: string; label: string; icon: string; exact?: boolean; external?: boolean; badge?: string; }
                  ...
                  return (
                    <Link
                      ...
                      onMouseEnter={e => {
                        ...
                        // Prefetch API data on hover for faster page loads
                        const endpoint = ADMIN_PREFETCH_MAP[item.href];
                        if (endpoint) {
                          prefetch(item.href, async () => {
