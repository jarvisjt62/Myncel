...
export default async function AdminChatPage() {
  ...
  const totalUnread = sessionsWithUnread.reduce((sum, chat) => sum + chat.unreadCount, 0);
  ...
  return (
    <div className="space-y-6">
      ...
      <AdminChatClient initialSessions={sessionsWithUnread} initialUnreadCount={totalUnread} />
    </div>
  );
}