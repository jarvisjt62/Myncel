...
export const metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.myncel.com/blog/hidden-cost-reactive-maintenance',
    type: 'article',
  },
}
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-[#425466] leading-relaxed mb-6">
            The good news is that the core functionality that prevents 80% of breakdowns — PM scheduling, work orders, alerts, and basic analytics — doesn't require a six-figure investment. Modern maintenance software built specifically for small manufacturers can deliver all of this for $49–$249/month. That's less than one hour of downtime.
          </p>
          ...
          <div className="bg-gradient-to-br from-[#635bff] to-[#4f46e5] rounded-2xl p-8 text-center mt-12">
            ...
            <p className="text-purple-100 mb-6">Join 200+ manufacturers who switched from spreadsheets to Myncel. Free for 30 days — no credit card required.</p>
