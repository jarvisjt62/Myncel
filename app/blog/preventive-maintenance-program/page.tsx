...
export const metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.myncel.com/blog/preventive-maintenance-program',
    type: 'article',
  },
}
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-3 mb-8">
            {[
              { name: 'Myncel (Recommended)', price: 'From $49/mo', desc: 'Built specifically for small manufacturers. Handles PM scheduling, work orders, alerts, parts inventory, and analytics. Setup in 15 minutes.', badge: 'Best for small shops' },
