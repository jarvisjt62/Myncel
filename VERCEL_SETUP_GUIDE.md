...
2. **NEXTAUTH_SECRET**
   - Value: generate a fresh secret with `openssl rand -base64 32` and keep it only in Vercel environment variables
   - Environments: Production, Preview, Development
...
**NEXTAUTH_SECRET:** Generate a fresh value locally with `openssl rand -base64 32`; do not commit or share the generated secret.
